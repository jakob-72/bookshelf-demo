...
void main() {
  ...
  group('login', () {
    ...
    test(
      'returns AuthResponse.unauthorized when login fails with 401',
      () async {
        const username = 'username';
        const password = 'password';
        when(
    ...
    test(
      'return AuthResponse.error when response body cannot be parsed',
      () async {
        const username = 'username';
        const password = 'password';
        when(
  ...
  group('Register', () {
    ...
    test(
      'returns RegisterResponse.success when registration succeeds',
      () async {
        const username = 'username';
        const password = 'password';
        when(
          ...
          (_) async =>
              Response(statusCode: 201, requestOptions: RequestOptions()),
        );
    ...
    test(
      'returns RegisterResponse.error for an unexpected status code',
      () async {
        const username = 'username';
        const password = 'password';
        when(
